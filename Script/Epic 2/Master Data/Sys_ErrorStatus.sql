...
BEGIN
	UPDATE Sys_ErrorStatus 
	SET Description= ErrorName 
    
    UPDATE Sys_ErrorStatus 
	SET Description= 'Error' 
    WHERE ErrorStatus = 70

    UPDATE Sys_ErrorStatus 
	SET Description= 'Integration Error'  
     WHERE ErrorStatus = 180

   UPDATE Sys_ErrorStatus 
	SET Description= 'Integration Warning'  
     WHERE ErrorStatus = 179
END
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('Upate_Sys_ErrorStatus.sql', 1);
GO
/* Tracking HISTORY */
