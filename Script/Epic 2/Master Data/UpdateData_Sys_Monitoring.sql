...
BEGIN
	IF  EXISTS (SELECT 1 FROM [dbo].[Sys_Monitoring] WHERE [ID] = 8 and [Name] = 'Intergration Error Transaction') 
	BEGIN
		UPDATE [dbo].[Sys_Monitoring] SET Name = N'Integration Error Transaction' WHERE ID = 8
	END
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('UpdateData_Sys_Monitoring.sql', 1);
GO
/* Tracking HISTORY */
