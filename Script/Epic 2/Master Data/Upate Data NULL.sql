...
BEGIN
	UPDATE i
	SET i.CreatedDate = t.CreatedDate
	FROM Trans_System_Health_Instance AS i,Trans_System_Health AS t
	WHERE i.RequestID = t.RequestID
	AND i.CreatedDate IS NULL
 
 
	UPDATE i
	SET i.CreatedDate = t.CreatedDate
	FROM Trans_System_Health_Instance AS i,history.Trans_System_Health_Archive  AS t
	WHERE i.RequestID = t.RequestID
	AND i.CreatedDate IS NULL
 
 
	UPDATE Trans_System_Health_Instance
