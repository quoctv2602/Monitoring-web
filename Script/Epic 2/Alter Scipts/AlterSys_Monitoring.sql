...
BEGIN
	IF NOT EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.[COLUMNS] AS c WHERE c.COLUMN_NAME =  'NodeType' AND c.TABLE_NAME = 'Sys_Monitoring' )
	BEGIN
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('AlterSys_Monitoring.sql', 1);
GO
/* Tracking HISTORY */
