...
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[history].[Trans_Data_Status_Archive]') AND type in (N'U'))
BEGIN
    CREATE TABLE [history].[Trans_Data_Status_Archive]
    (
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('5.history.Trans_Data_Status_Archive.sql', 1);
GO
/* Tracking HISTORY */
