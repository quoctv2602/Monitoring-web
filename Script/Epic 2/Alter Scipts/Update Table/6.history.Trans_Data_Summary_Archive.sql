...
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[history].[Trans_Data_Summary_Archive]') AND type in (N'U'))
BEGIN
    CREATE TABLE [history].[Trans_Data_Summary_Archive]
    (
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('6.history.Trans_Data_Summary_Archive.sql', 1);
GO
/* Tracking HISTORY */
