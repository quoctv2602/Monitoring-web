...
IF EXISTS (SELECT 1
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[history].[ListErrorBase_Archive]') AND type in (N'U'))
BEGIN
    DROP TABLE [history].[ListErrorBase_Archive]
END
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('11.DROPTABLE [history].[ListErrorBase_Archive]', 1);
GO
/* Tracking HISTORY */
