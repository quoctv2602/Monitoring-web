...
IF EXISTS (SELECT 1
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[dbo].[Trans_Request_History]') AND type in (N'U'))
BEGIN
    DROP TABLE [dbo].[Trans_Request_History]
END
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('9.DROP TABLE [Trans_Request_History].sql', 1);
GO
/* Tracking HISTORY */
