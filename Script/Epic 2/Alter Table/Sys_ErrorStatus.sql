...
BEGIN
    IF Not EXISTS(SELECT 1 FROM sys.columns  WHERE Name = N'GroupCode' AND Object_ID = Object_ID(N'Sys_ErrorStatus'))
	BEGIN
		ALTER TABLE Sys_ErrorStatus
		ADD GroupCode int;
	END
END
