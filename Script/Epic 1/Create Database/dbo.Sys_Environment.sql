...
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[dbo].[Sys_Environment]') AND type in (N'U'))
	BEGIN
    CREATE TABLE [dbo].[Sys_Environment]
    (
        [ID] [int] IDENTITY(1,1) NOT NULL,
        [Name] [nvarchar](250) NULL,
        [Comment] [varchar](500) NULL,
        CONSTRAINT [PK_Sys_Environment] PRIMARY KEY CLUSTERED 
		(
			[ID] ASC
