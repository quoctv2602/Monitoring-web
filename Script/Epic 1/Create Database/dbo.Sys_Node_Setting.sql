...
WHERE object_id = OBJECT_ID(N'[dbo].[Sys_Node_Setting]') AND type in (N'U'))
	BEGIN
    CREATE TABLE [dbo].[Sys_Node_Setting]
    (
        ...
        [ServiceList] [nvarchar](4000) NULL,
        [NotificationEmail] [nvarchar](max) NULL,
        [ReportEmail] [nvarchar](max) NULL,
        [NotificationAlias] [nvarchar](max) NULL,
        [ReportAlias] [nvarchar](max) NULL,
        [CreateDate] [datetime] NULL,
        [IsActive] [bit] NULL,
        CONSTRAINT [PK_Sys_Node_Setting] PRIMARY KEY CLUSTERED 
		(
			[ID] ASC
