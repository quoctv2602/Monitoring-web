...
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[history].[Trans_System_Health_Storage_Archive]') AND type in (N'U'))
	BEGIN
			CREATE TABLE [history].[Trans_System_Health_Storage_Archive](
		...
		[DayofYear] [int] NULL,
		[Date] [int] NULL,
	 CONSTRAINT [PK_Trans_System_Health_Storage_Archive] PRIMARY KEY CLUSTERED 
	(
		[ID] ASC
...
INSERT INTO [dbo].[DBScriptHistory]
	([FileName],[Version])
VALUES('history.Trans_System_Health_Storage_Archive.sql', 3);
GO
/* Tracking HISTORY */
