...
BEGIN
	UPDATE [dbo].[Sys_Action] 
	SET ActionName=N'Manage Node (Add/Edit/Delete)'
	WHERE ActionId=12
	

	UPDATE [dbo].[Sys_Action] 
	SET ActionName=N'Manage Group (Add/Edit/Delete)'
	WHERE ActionId=42

	UPDATE [dbo].[Sys_Action] 
	SET ActionName=N'Manage User (Add/Edit/Delete)'
	WHERE ActionId=46

	UPDATE [dbo].[Sys_Action] 
	SET ActionName=N'Manage Notification (Add/Edit/Delete)'
	WHERE ActionId=52
END
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('Upate_ActionName_Action.sql', 5);
GO
/* Tracking HISTORY */
