...
GO
/* Begin SCRIPTS*/
	IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sys_Monitoring_Session]') AND type in (N'U'))
	BEGIN
		CREATE TABLE [dbo].[Sys_Monitoring_Session](
...
VALUES('Sys_Monitoring_Session',5);
GO
/* Tracking HISTORY */
