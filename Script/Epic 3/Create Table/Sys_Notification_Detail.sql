...
FROM sys.objects
WHERE object_id = OBJECT_ID(N'[dbo].[Sys_Notification_Detail]') AND type in (N'U'))
BEGIN
	CREATE TABLE [dbo].[Sys_Notification_Detail](
	[ID] [int] IDENTITY(1,1) NOT NULL,
	[NotificationId] [int] NULL,
	[KPI] [int] NULL,
	[Emails] [nvarchar](max) NULL,
	[NotificationAlias] [nvarchar](500) NULL,
	 CONSTRAINT [PK_Sys_Notification_Detail] PRIMARY KEY CLUSTERED 
	(
		[ID] ASC
...
INSERT INTO [dbo].[DBScriptHistory]
    ([FileName],[Version])
VALUES('Sys_Notification_Detail.sql', 1);
GO
/* Tracking HISTORY */
