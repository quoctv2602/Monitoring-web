...
namespace Monitoring_Common.DataContext
{
    public sealed class SqlHelper
    {
        #region Information for connection

        /// <summary>
        /// Declare a string connection to connect to sql server.
        /// </summary>
        ...
        public static int ExecuteInsertDataTable(string connectionString, string spName, params object[] parameterValues)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    return DBRetryHelper.Default.Execute(() =>
                    {
        ...
        public static int ExecuteNonQuery(string ConnString, string Query)
        {
            ...
            try
            {
                ...
                {
                    DBRetryHelper.Default.Execute(() => conn.Open());
                    using (var cmd = conn.CreateCommand())
                    {
                        cmd.CommandText = Query;
                        cmd.CommandTimeout = 30000;
                        return DBRetryHelper.Default.Execute(() => cmd.ExecuteNonQuery());
                    }
                }
            }
            catch (Exception e)
        ...
        public static DataSet ExecuteQuery(string ConnString, string Query)
        {
            var ds = new DataSet();
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnString))
                {
                    ...
                    using (var cmd = conn.CreateCommand())
                    {
                        ...
                        {
                            DBRetryHelper.Default.Execute(() => dataAdapter.Fill(ds));
                        }
                    }
                }
            }
        ...
        public static List<T> RawSqlQuery<T>(string ConnString, string query, Func<DbDataReader, T> map)
        {
            using (SqlConnection conn = new SqlConnection(ConnString))
            {
                conn.Open();
